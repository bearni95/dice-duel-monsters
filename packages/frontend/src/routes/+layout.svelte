...
<div class="contents" style:--navbar-h="0px">
	{#if true}
		<ScatteredCardsBackdrop
			cardIds={[
				10000000, 10000020, 10071456, 10202894, 10485110, 10000000, 10000020, 10071456, 10202894,
				10485110, 10000000, 10000020, 10071456, 10202894, 10485110, 10000000, 10000020, 10071456,
				10202894, 10485110, 10000000, 10000020, 10071456, 10202894, 10485110, 10000000, 10000020,
				10071456, 10202894, 10485110, 10000000, 10000020, 10071456, 10202894, 10485110, 10000000,
				10000020, 10071456, 10202894, 10485110, 10000000, 10000020, 10071456, 10202894, 10485110,
				10000000, 10000020, 10071456, 10202894, 10485110, 10000000, 10000020, 10071456, 10202894,
				10485110, 10000000, 10000020, 10071456, 10202894, 10485110
			]}
			classes="-z-10 opacity-30"
		/>
	{/if}
